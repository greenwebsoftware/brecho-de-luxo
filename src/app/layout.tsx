  ...
  '@graph': [
    {
      ...
      hasOfferCatalog: {
        ...
        name: 'Peças de Luxo',
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Bolsas de Luxo' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Roupas de Luxo' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Calçados de Luxo' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Acessórios de Luxo' } },
        ],
      },
    },
    {
